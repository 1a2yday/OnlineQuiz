(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=n(a);fetch(a.href,r)}})();const D=new Map;let K="home";function L(e,t){D.set(e,t)}function y(e){K=e,window.location.hash!==`#${e}`&&(window.location.hash=e);const t=D.get(e);t&&(t(),window.scrollTo(0,0))}window.addEventListener("hashchange",()=>{const e=window.location.hash.replace("#","");e&&D.has(e)&&e!==K&&(K=e,D.get(e)(),window.scrollTo(0,0))});const g={QUIZ_BANKS:"english_quiz_banks",USERS:"english_quiz_users",CURRENT_USER:"english_quiz_current_user",QUIZ_RECORDS:"english_quiz_records",WRONG_QUESTIONS:"english_quiz_wrong_questions",BLACKLIST:"english_quiz_blacklist",APP_CONFIG:"english_quiz_config"};function I(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}}function v(e,t){localStorage.setItem(e,JSON.stringify(t))}const ge="english_quiz_remote_cache";async function X(){try{const e=await fetch("quizzes/manifest.json");if(!e.ok)return;const t=await e.json(),n=[];for(const s of t)try{const a=await fetch(`quizzes/${s.file}`);if(!a.ok)continue;const r=await a.json();if(!r.name||!Array.isArray(r.questions))continue;n.push({id:`remote_${s.id}`,name:s.name,questions:r.questions,createdAt:0})}catch{console.warn(`远程题库加载失败: ${s.file}`)}v(ge,n),window.dispatchEvent(new CustomEvent("remote-quizzes-loaded"))}catch{}}function Qe(){return I(ge,[])}function C(){const e=I(g.QUIZ_BANKS,[]);return[...Qe(),...e]}function be(){return I(g.QUIZ_BANKS,[])}function Re(e){if(e.id.startsWith("remote_"))return;const t=be(),n=t.findIndex(s=>s.id===e.id);n>=0?t[n]=e:t.push(e),v(g.QUIZ_BANKS,t)}function ee(e){if(e.startsWith("remote_"))return;const t=be().filter(n=>n.id!==e);v(g.QUIZ_BANKS,t)}function W(){return I(g.USERS,[])}function w(){return I(g.CURRENT_USER,null)}function te(e){if(v(g.CURRENT_USER,e),e){const t=W();t.find(n=>n.id===e.id)||(t.push(e),v(g.USERS,t))}}function he(e){const t=W().filter(r=>r.id!==e);v(g.USERS,t);const n=w();n&&n.id===e&&te(null);const s=G().filter(r=>r.userId!==e);v(g.QUIZ_RECORDS,s);const a=F().filter(r=>r.userId!==e);v(g.WRONG_QUESTIONS,a)}function G(){return I(g.QUIZ_RECORDS,[])}function Ue(e){const t=G();t.push(e),v(g.QUIZ_RECORDS,t)}function j(e){return G().filter(t=>t.quizBankId===e).sort((t,n)=>{const s=t.correctCount/t.totalCount,a=n.correctCount/n.totalCount;return a!==s?a-s:t.timeSeconds-n.timeSeconds})}function F(){return I(g.WRONG_QUESTIONS,[])}function V(e,t,n){const s=F(),a=s.find(r=>r.userId===e&&r.questionId===t);a?(a.wrongCount+=1,a.mastered=!1):s.push({userId:e,questionId:t,quizBankId:n,wrongCount:1,mastered:!1}),v(g.WRONG_QUESTIONS,s)}function ve(e,t){const n=F(),s=n.find(a=>a.userId===e&&a.questionId===t);s&&(s.mastered=!0,v(g.WRONG_QUESTIONS,n))}function we(e){return F().filter(t=>t.userId===e&&!t.mastered)}function Ee(e,t){const n=F().find(s=>s.userId===e&&s.questionId===t);return n?n.wrongCount:0}function P(){return I(g.BLACKLIST,[])}function ke(e,t){const n=P();n.find(s=>s.userId===e)||(n.push({userId:e,userName:t,timestamp:Date.now()}),v(g.BLACKLIST,n))}function Ie(e){const t=P().filter(n=>n.userId!==e);v(g.BLACKLIST,t)}function ne(e){return P().some(t=>t.userId===e)}const He={bannerUrl:"banner.gif",adminPasswordHash:"",welcomeTitle:"英语刷题助手",welcomeSubtitle:"每天进步E点点"};function O(){const e=I(g.APP_CONFIG,{});return{...He,...e}}function z(e){const t=O();v(g.APP_CONFIG,{...t,...e})}const Q=Object.freeze(Object.defineProperty({__proto__:null,addToBlacklist:ke,deleteQuizBank:ee,deleteUserData:he,getAppConfig:O,getBlacklist:P,getCurrentUser:w,getLeaderboard:j,getQuizBanks:C,getQuizRecords:G,getUserWrongQuestions:we,getUsers:W,getWrongCountForQuestion:Ee,getWrongQuestions:F,isBlacklisted:ne,loadRemoteQuizzes:X,markWrongQuestionMastered:ve,recordWrongAnswer:V,removeFromBlacklist:Ie,saveQuizBank:Re,saveQuizRecord:Ue,setAppConfig:z,setCurrentUser:te},Symbol.toStringTag,{value:"Module"})),R=[{id:"honey-lemon",name:"蜂蜜柠檬糖",emoji:"🍯",primary:"#FF8C42",primaryLight:"#FFAA70",secondary:"#FFB347",secondaryLight:"#FFC773",accent:"#2EC4A7",highlight:"#FFC940",background:"#FFF8F0",card:"#FFFFFF",text:"#4A3030",textSecondary:"#8B7070",textMuted:"#B8A0A0",textLight:"#C8B0A0",border:"#FFE0D0",borderStrong:"#FFC8A8",bgLight:"#FFF5EE",shadow:"rgba(255, 140, 66, 0.15)",shadowHover:"rgba(255, 140, 66, 0.25)",primaryGradient:"linear-gradient(135deg, #FF8C42, #FFAA70)",secondaryGradient:"linear-gradient(135deg, #FFB347, #FFC773)",accentGradient:"linear-gradient(135deg, #2EC4A7, #50D8B8)",highlightGradient:"linear-gradient(135deg, #FFC940, #FFD970)"},{id:"mint",name:"薄荷糖",emoji:"🍃",primary:"#00BFA5",primaryLight:"#33CFB5",secondary:"#26A69A",secondaryLight:"#4DB6AC",accent:"#00D2A0",highlight:"#FFC940",background:"#F0FFFA",card:"#FFFFFF",text:"#2D4040",textSecondary:"#5C7070",textMuted:"#90A0A0",textLight:"#A8B8B8",border:"#C8E8E0",borderStrong:"#A0D8C8",bgLight:"#E8F8F2",shadow:"rgba(0, 191, 165, 0.15)",shadowHover:"rgba(0, 191, 165, 0.25)",primaryGradient:"linear-gradient(135deg, #00BFA5, #33CFB5)",secondaryGradient:"linear-gradient(135deg, #26A69A, #4DB6AC)",accentGradient:"linear-gradient(135deg, #00D2A0, #33E0B8)",highlightGradient:"linear-gradient(135deg, #FFC940, #FFD970)"},{id:"strawberry",name:"草莓糖",emoji:"🍓",primary:"#FF6B9D",primaryLight:"#FF85B3",secondary:"#9B59B6",secondaryLight:"#B07CD8",accent:"#00D2A0",highlight:"#FFD93D",background:"#FFF0F5",card:"#FFFFFF",text:"#4A3040",textSecondary:"#8B7080",textMuted:"#B8A0B0",textLight:"#C8B0C0",border:"#FFE0EC",borderStrong:"#FFB8D0",bgLight:"#FFF5F7",shadow:"rgba(255, 107, 157, 0.15)",shadowHover:"rgba(255, 107, 157, 0.25)",primaryGradient:"linear-gradient(135deg, #FF6B9D, #FF85B3)",secondaryGradient:"linear-gradient(135deg, #9B59B6, #B07CD8)",accentGradient:"linear-gradient(135deg, #00D2A0, #33E0B8)",highlightGradient:"linear-gradient(135deg, #FFD93D, #FFE566)"},{id:"blueberry",name:"蓝莓糖",emoji:"🫐",primary:"#667EEA",primaryLight:"#8295F0",secondary:"#764BA2",secondaryLight:"#9568C0",accent:"#00D2A0",highlight:"#FFC940",background:"#F2F0FF",card:"#FFFFFF",text:"#303048",textSecondary:"#686880",textMuted:"#9898B0",textLight:"#B0B0C8",border:"#D8D8F0",borderStrong:"#C0C0E8",bgLight:"#ECEAFA",shadow:"rgba(102, 126, 234, 0.15)",shadowHover:"rgba(102, 126, 234, 0.25)",primaryGradient:"linear-gradient(135deg, #667EEA, #8295F0)",secondaryGradient:"linear-gradient(135deg, #764BA2, #9568C0)",accentGradient:"linear-gradient(135deg, #00D2A0, #33E0B8)",highlightGradient:"linear-gradient(135deg, #FFC940, #FFD970)"}],me="honey-lemon",Se="english_quiz_theme";function Le(){try{return localStorage.getItem(Se)||me}catch{return me}}function We(e){localStorage.setItem(Se,e)}function Y(){const e=Le();return R.find(t=>t.id===e)||R[0]}function Be(e){const t=document.documentElement;t.style.setProperty("--c-primary",e.primary),t.style.setProperty("--c-primary-light",e.primaryLight),t.style.setProperty("--c-secondary",e.secondary),t.style.setProperty("--c-secondary-light",e.secondaryLight),t.style.setProperty("--c-accent",e.accent),t.style.setProperty("--c-highlight",e.highlight),t.style.setProperty("--c-background",e.background),t.style.setProperty("--c-card",e.card),t.style.setProperty("--c-text",e.text),t.style.setProperty("--c-text-secondary",e.textSecondary),t.style.setProperty("--c-text-muted",e.textMuted),t.style.setProperty("--c-text-light",e.textLight),t.style.setProperty("--c-border",e.border),t.style.setProperty("--c-border-strong",e.borderStrong),t.style.setProperty("--c-bg-light",e.bgLight),t.style.setProperty("--c-shadow",e.shadow),t.style.setProperty("--c-shadow-hover",e.shadowHover),t.style.setProperty("--c-primary-gradient",e.primaryGradient),t.style.setProperty("--c-secondary-gradient",e.secondaryGradient),t.style.setProperty("--c-accent-gradient",e.accentGradient),t.style.setProperty("--c-highlight-gradient",e.highlightGradient)}function Ge(){const e=Y();return Be(e),e}const Ve="modulepreload",Je=function(e,t){return new URL(e,t).href},pe={},A=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let i=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};const o=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),d=c?.nonce||c?.getAttribute("nonce");a=i(n.map(l=>{if(l=Je(l,s),l in pe)return;pe[l]=!0;const u=l.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(s)for(let p=o.length-1;p>=0;p--){const h=o[p];if(h.href===l&&(!u||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${m}`))return;const x=document.createElement("link");if(x.rel=u?"stylesheet":Ve,u||(x.as="script"),x.crossOrigin="",x.href=l,d&&x.setAttribute("nonce",d),document.head.appendChild(x),u)return new Promise((p,h)=>{x.addEventListener("load",p),x.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return a.then(o=>{for(const c of o||[])c.status==="rejected"&&r(c.reason);return t().catch(r)})};function $e(){const e="abcdefghijklmnopqrstuvwxyz0123456789";let t="";for(let n=0;n<12;n++)t+=e.charAt(Math.floor(Math.random()*e.length));return`u_${t}_${Date.now().toString(36)}`}function _e(){return`qb_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,8)}`}function Ce(){return`q_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,8)}`}function _(e){const t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`}function se(e){const t=[...e];for(let n=t.length-1;n>0;n--){const s=Math.floor(Math.random()*(n+1));[t[n],t[s]]=[t[s],t[n]]}return t}function Ae(e){const t=e.trim();if(!t)return{valid:!1,error:"名字不能为空"};const n=(t.match(/[\u4e00-\u9fff]/g)||[]).length,s=(t.match(/[a-zA-Z]/g)||[]).length,a=t.length-n-s;return n>5?{valid:!1,error:"中文最多5个字符"}:s>10?{valid:!1,error:"英文最多10个字符"}:a>0?{valid:!1,error:"名字只能包含中文或英文字母"}:n===0&&s===0?{valid:!1,error:"名字至少包含一个中文字或英文字母"}:t.length>15?{valid:!1,error:"名字总长度不能超过15个字符"}:{valid:!0,error:""}}const Ze=[/[^\u4e00-\u9fffa-zA-Z0-9_\-\s]/g];function Fe(e){const t=e.trim().toLowerCase(),n=["admin","root","system","test","null","管理员","系统","超级管理员","版主"];for(const s of n)if(t.includes(s.toLowerCase()))return!0;for(const s of Ze){const a=t.match(s);if(a&&a.length>2)return!0}return!1}async function ae(e){const t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(a=>a.toString(16).padStart(2,"0")).join("")}function S(e){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"};return e.replace(/[&<>"'`]/g,n=>t[n]||n)}function re(e){if(!e)return!1;if(/^(\.{0,2}\/|[a-zA-Z0-9_-])/.test(e)&&!/^[a-zA-Z][a-zA-Z0-9+.-]*:/.test(e))return!0;try{const t=new URL(e);return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}const Ke="240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9";async function Te(e){try{const n=O().adminPasswordHash||Ke;return await ae(e)===n}catch(t){return console.error("密码验证失败:",t),!1}}async function qe(e){const t=await ae(e);z({adminPasswordHash:t})}function J(e){try{return JSON.parse(localStorage.getItem("english_quiz_admins")||"[]").includes(e)}catch{return!1}}function ze(e,t){try{const n=JSON.parse(localStorage.getItem("english_quiz_admins")||"[]");t&&!n.includes(e)&&n.push(e),localStorage.setItem("english_quiz_admins",JSON.stringify(n))}catch{}}const Ye=Object.freeze(Object.defineProperty({__proto__:null,escapeHtml:S,formatTime:_,generateQuestionId:Ce,generateQuizBankId:_e,generateUserId:$e,hasSensitiveWords:Fe,isAdminUser:J,isValidUrl:re,setAdminPassword:qe,setAdminUser:ze,sha256:ae,shuffle:se,validateName:Ae,verifyAdminPassword:Te},Symbol.toStringTag,{value:"Module"}));function Me(){const e=document.getElementById("app");if(!e)return;const t=w();if(!t){y("name-entry");return}if(ne(t.id)){e.innerHTML=`
      ...
      </div>`;return}const n=O(),s=J(t.id),r=`
    <img src="${n.bannerUrl&&re(n.bannerUrl)?S(n.bannerUrl):"banner.gif"}" alt="Banner"
    ...
    <div class="phone-container flex flex-col min-h-screen p-4">
      ...
      <div class="card-candy mt-4 p-3 animate-fade-in-up delay-500">
        ...
        <p class="text-xs text-candy-text-muted text-center mt-1" id="theme-name-label">${Y().emoji} ${Y().name}</p>
      </div>
    ...
    </div>`,document.getElementById("quit-quiz-btn")?.addEventListener("click",()=>{confirm("确定要退出答题吗？当前进度不会保存。")&&(De(),y(f.isWrongQuestionsMode?"wrong-questions":"quiz-bank"))}),t.type==="single-choice"?ct(t):t.type==="matching"?mt(t):t.type==="sentence-order"&&yt(t)}function E(e){return e.replace(/\n/g,"<br>")}function dt(e){const t=e.options.map((n,s)=>`
  ...
  `).join(""),n=se(e.right.map((s,a)=>({item:s,origIdx:a}))).map(({item:s,origIdx:a})=>`
  ...
  `).join("");return`
    <div class="card-candy">
      ...
      <div id="explanation-area" class="hidden mt-4 p-3 rounded-xl bg-candy-bg-light border border-candy-border text-sm text-candy-text-secondary leading-relaxed"></div>
    </div>`}function yt(e){const t=document.getElementById("submit-answer-btn"),n=document.getElementById("next-question-btn"),s=document.getElementById("sentence-result"),a=document.getElementById("sentence-words");function r(){if(!s||!a)return;const{selectedOrder:o,availableIndices:c}=k;o.length===0?s.innerHTML='<span class="text-sm text-candy-text-light">按正确顺序点击下方单词...</span>':(s.innerHTML=o.map((d,i)=>`
        <span class="word-chip selected-for-order cursor-pointer" data-remove="${i}">${E(e.words[d])}</span>
      `).join(""),s.querySelectorAll("[data-remove]").forEach(d=>{d.addEventListener("click",()=>{const i=Number(d.dataset.remove),l=k.selectedOrder.splice(i,1)[0];k.availableIndices.push(l),k.availableIndices.sort((u,m)=>u-m),r()})})),a.innerHTML=c.map(d=>`
      <span class="word-chip word-available cursor-pointer" data-index="${d}">${E(e.words[d])}</span>
    `).join(""),a.querySelectorAll(".word-available").forEach(d=>{d.addEventListener("click",()=>{const i=Number(d.dataset.index),l=k.availableIndices.indexOf(i);l>=0&&(H(),k.availableIndices.splice(l,1),k.selectedOrder.push(i),r())})}),o.length===e.words.length?t&&(t.style.display=""):t&&(t.style.display="none")}r(),t?.addEventListener("click",()=>{const o=[...k.selectedOrder],c=bt(o,e.answer);if(f.answers.push(o),f.answeredCorrect.push(c),c)Pe();else{de();const d=w();d&&V(d.id,e.id,le(e.id))}if(s){const d=e.answer.map(i=>e.words[i]).join(" ");c?s.innerHTML='<div class="text-candy-accent font-bold animate-bounce-in">✓ 正确！</div>':s.innerHTML=`
          <div class="text-candy-primary font-bold animate-shake">✗ 错误</div>
          <div class="text-sm text-candy-text-secondary mt-1">正确顺序：${d}</div>`}ce(e.explanation),t&&(t.style.display="none"),a&&a.querySelectorAll(".word-available").forEach(d=>d.style.pointerEvents="none"),s&&s.querySelectorAll(".selected-for-order").forEach(d=>d.style.pointerEvents="none"),n&&(n.style.display="")},{once:!0}),n?.addEventListener("click",()=>{f.currentIndex++,N()})}function xt(){De();const e=f.elapsedSeconds,t=f.answeredCorrect.filter(Boolean).length,n=f.questions.length,s=w(),a=C();if(f.isWrongQuestionsMode){if(s){const r=new Map;f.questions.forEach((o,c)=>{const d=f.wrongBankIdMap[o.id]||"__unknown__",i=r.get(d)||{correct:0,total:0};i.total+=1,f.answeredCorrect[c]&&(i.correct+=1),r.set(d,i)}),A(async()=>{const{saveQuizRecord:o}=await Promise.resolve().then(()=>Q);return{saveQuizRecord:o}},void 0,import.meta.url).then(({saveQuizRecord:o})=>{r.forEach((c,d)=>{const i=a.find(l=>l.id===d);o({userId:s.id,userName:s.name,quizBankId:d,quizBankName:i?.name||"错题重刷",correctCount:c.correct,totalCount:c.total,timeSeconds:e,timestamp:Date.now()})})})}sessionStorage.setItem("quiz_result",JSON.stringify({correctCount:t,totalCount:n,timeSeconds:e,quizBankId:"",quizBankName:"错题重刷",isWrongQuestionsMode:!0}))}else{const r=ie(),o=a.find(c=>c.id===r);s&&o&&A(async()=>{const{saveQuizRecord:c}=await Promise.resolve().then(()=>Q);return{saveQuizRecord:c}},void 0,import.meta.url).then(({saveQuizRecord:c})=>{c({userId:s.id,userName:s.name,quizBankId:o.id,quizBankName:o.name,correctCount:t,totalCount:n,timeSeconds:e,timestamp:Date.now()})}),sessionStorage.setItem("quiz_result",JSON.stringify({correctCount:t,totalCount:n,timeSeconds:e,quizBankId:r||"",quizBankName:o?.name||"未知题库",isWrongQuestionsMode:!1}))}y("quiz-result")}function ce(e){const t=document.getElementById("explanation-area");t&&e&&(t.innerHTML=`<span class="font-bold text-candy-primary">💡 解析：</span>${E(e)}`,t.classList.remove("hidden"))}function le(e){return f.isWrongQuestionsMode?f.wrongBankIdMap[e]||"":ie()||""}function gt(e){switch(e){case"single-choice":return"单选题";case"matching":return"消消乐";case"sentence-order":return"还原句子";default:return e}}function bt(e,t){return e.length!==t.length?!1:e.every((n,s)=>n===t[s])}function ht(){const e=document.getElementById("app");if(!e)return;const t=sessionStorage.getItem("quiz_result");if(!t){y("home");return}const n=JSON.parse(t),s=n.totalCount>0?Math.round(n.correctCount/n.totalCount*100):0,a=j(n.quizBankId).slice(0,10),r=c=>c>=90?"🌟":c>=70?"👍":c>=50?"💪":"📚",o=a.length>0?a.map((c,d)=>`
  ...
  `).join(""),s=t[0],a=j(s.id),r=a.length>0?a.map((o,c)=>`
    ...
    <div class="phone-container flex flex-col min-h-screen p-4">
      ...
      <div class="flex-1" id="leaderboard-list">
        ${r}
          ...
          `).join(""):'<p class="text-center text-candy-text-muted text-sm py-8">暂无记录，快去刷题吧！</p>')})})}function B(){const e=document.getElementById("app");if(!e)return;const t=w();if(!t||!J(t.id)){y("home");return}const n=O(),s=P(),a=W(),r=C(),o=s.length===0?'<p class="text-sm text-candy-text-muted text-center py-4">黑名单为空</p>':s.map(i=>`
    ...
    <div class="phone-container flex flex-col min-h-screen p-4">
      ...
      <div class="space-y-4">
        ...
        <div class="card-candy animate-fade-in-up">
          ...
          ${re(n.bannerUrl)?`<img src="${S(n.bannerUrl)}" class="w-full rounded-xl max-h-32 object-cover mb-2" onerror="this.style.display='none'" />`:""}
    ...
    </div>`,document.getElementById("back-home-btn")?.addEventListener("click",()=>y("home")),document.getElementById("save-banner-btn")?.addEventListener("click",()=>{const i=document.getElementById("banner-input");i&&(z({bannerUrl:i.value.trim()||"banner.gif"}),B())}),document.getElementById("reset-banner-btn")?.addEventListener("click",()=>{z({bannerUrl:"banner.gif"}),B()}),document.getElementById("save-welcome-btn")?.addEventListener("click",()=>{const i=document.getElementById("welcome-title-input"),l=document.getElementById("welcome-subtitle-input");z({welcomeTitle:i?.value.trim()||"英语刷题助手",welcomeSubtitle:l?.value.trim()||"每天进步E点点"}),B()}),document.getElementById("change-pwd-btn")?.addEventListener("click",async()=>{const i=document.getElementById("admin-old-pwd")?.value||"",l=document.getElementById("admin-new-pwd")?.value.trim()||"",u=document.getElementById("pwd-msg"),m=h=>{u&&(u.textContent=h,u.classList.remove("hidden"))};if(l.length<6){m("新密码至少6位");return}const{verifyAdminPassword:x}=await A(async()=>{const{verifyAdminPassword:h}=await Promise.resolve().then(()=>Ye);return{verifyAdminPassword:h}},void 0,import.meta.url);if(!await x(i)){m("当前密码错误");return}await qe(l),localStorage.removeItem("english_quiz_admins"),m("密码修改成功！下次访问管理面板请用新密码。"),document.getElementById("admin-old-pwd").value="",document.getElementById("admin-new-pwd").value="",setTimeout(()=>u?.classList.add("hidden"),3e3)}),document.querySelectorAll(".block-btn").forEach(i=>{i.addEventListener("click",()=>{const l=i,u=l.dataset.userId,m=l.dataset.userName;u&&m&&confirm(`确定拉黑用户「${m}」吗？将删除其所有数据。`)&&(ke(u,m),he(u),B())})}),document.querySelectorAll(".unblock-btn").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.userId;l&&confirm("确定解除拉黑吗？")&&(Ie(l),B())})}),document.querySelectorAll(".delete-bank-btn").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.bankId;l&&confirm("确定删除该题库吗？此操作不可撤销。")&&(ee(l),B())})})}Ge();L("home",Me);L("name-entry",Xe);L("quiz-bank",M);L("quiz",rt);L("quiz-result",ht);L("wrong-questions",ue);L("leaderboard",It);L("admin",B);function St(){X();const e=w();if(e&&ne(e.id)){const n=document.getElementById("app");n&&(n.innerHTML=`
        <div class="phone-container flex items-center justify-center p-6">
          <div class="card-candy text-center p-8 w-full">
            <div class="text-5xl mb-4">🚫</div>
            <h2 class="text-xl font-bold text-candy-text mb-2">账户已被禁用</h2>
