      ...
      <div class="space-y-4">
        ...
        <div class="card-candy animate-fade-in-up">
          ...
          <div class="flex gap-2 mb-3">
            <input id="banner-input" type="text" value="${config.bannerUrl}" placeholder="banner.gif"
          ...
          ${config.bannerUrl ? `<img src="${config.bannerUrl}" class="w-full rounded-xl max-h-32 object-cover mb-2" onerror="this.style.display='none'" />` : ''}
          ...
          <div class="mt-4 pt-4 border-t border-candy-border">
            ...
            <input id="welcome-title-input" type="text" value="${config.welcomeTitle.replace(/"/g, '&quot;')}" placeholder="欢迎标题"
            ...
            <input id="welcome-subtitle-input" type="text" value="${config.welcomeSubtitle.replace(/"/g, '&quot;')}" placeholder="欢迎副标题"
              class="w-full px-4 py-2 rounded-xl border-2 border-candy-border text-sm text-candy-text outline-none focus:border-candy-primary mb-2" />
